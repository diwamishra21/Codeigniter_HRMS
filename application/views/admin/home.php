<?php // echo $hour;exit;    ?>
<?php if ($access_type != 'super admin') { ?>
    <?PHP if (empty($notice)) { ?>
        <marquee BGCOLOR=YELLOW behavior="slide">No Announcement </marquee>
    <?php } else { ?>
        <marquee BGCOLOR=#ddd scrollamount="4" behavior="loop"style="font-size:20px;"><?PHP echo $notice[0]->title; ?> &nbsp; <?php echo $notice[0]->description; ?></marquee>
        <?PHP
    }
}
?>
...
<?php
//var_dump($week_data);exit;
//$time = gmdate("H:i", $week_data[6]['d_value']);
////var_dump($time);exit;  
//$date1 = date('H',$time);
//var_dump($date1);exit;
//$time1 = gmdate("H:i", $week_data[5]['d_value']);
//$date2 = date('H',$time1);
//$time2 = gmdate("H:i", $week_data[4]['d_value']);
//$date3 = date('H',$time2);
//$time3 = gmdate("H:i", $week_data[3]['d_value']);
//$date4 = date('H',$time3);
////var_dump($date4);exit;  
//$time4 = gmdate("H:i", $week_data[2]['d_value']);
//$date5 = date('H',$time4);
//$time5 = gmdate("H:i", $week_data[1]['d_value']);
//$date6 = date('H',$time5);
//$time6 = gmdate("H:i", $week_data[0]['d_value']);
//$date7 = date('H',$time6);
...
<?php if ($access_type == 'super admin') { ?>
    <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 blue" href="<?php echo base_url('admin/home/emp_list'); ?>">
                <div class="visual">
                    <i class="fa fa-users"></i>
                </div>
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="1349"><?php echo $emp; ?></span>
                    </div>
                    <div class="desc"> Total Employess </div>
                </div>
            </a>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 red" href="#">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="12,5"><?php echo $hour; ?></span></div>
                    <div class="desc"> Total Working Hours </div>
                </div>
            </a>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 green" href="<?php echo base_url('admin/home/employees_leaves'); ?>">
                <div class="visual">
                    <i class="fa fa-shopping-cart"></i>
                </div>
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="549"><?php echo $total_leaves; ?></span>
                    </div>
                    <div class="desc"> Total Leaves </div>
                </div>
            </a>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
...
<?php
//  $time = gmdate("H:i",$week_data[3]['d_value']);
//var_dump($time);exit;
//echo $time; 
?>
...
<script src="<?php echo base_url(); ?>/assets/pages/scripts/charts-morris.min.js" type="text/javascript"></script>
...
<script type="text/javascript">
    $(function () {
        var a =<?php echo $week_data[9]['d_value']; ?>;
        var b =<?php echo $week_data[7]['d_value']; ?>;
        var c =<?php echo $week_data[5]['d_value']; ?>;
        var d =<?php echo $week_data[13]['d_value']; ?>;
        var e =<?php echo $week_data[9]['d_value']; ?>;
        var f =<?php echo $week_data[1]['d_value']; ?>;
        var g =<?php echo $week_data[1]['d_value']; ?>;
        ...
        Highcharts.chart('container', {
            ...
            title: {
                text: 'Attendance Report of All Employees'
            },
            tooltip: {
            ...
            series: [{
                    ...
                    colorByPoint: true,
                    data: [{
                            name: '<?php echo date('jS F Y', strtotime('-7 day')); ?>',
                            y: a
                        }, {
                            name: '<?php echo date('jS F Y', strtotime('-6 day')); ?>',
                            y: b,
                            sliced: true,
                            selected: true
                        }, {
                            name: '<?php echo date('jS F Y', strtotime('-5 day')); ?>',
                            y: c
                        }, {
                            name: '<?php echo date('jS F Y', strtotime('-4 day')); ?>',
                            y: d
                        }, {
                            name: '<?php echo date('jS F Y', strtotime('-3 day')); ?>',
                            y: e
                        },
                        {
                            name: '<?php echo date('jS F Y', strtotime('-2 day')); ?>',
                            y: f
                        },
                        {
                            name: '<?php echo date('jS F Y', strtotime('-1 day')); ?>',
                            y: g
                        }]
                }]
        });
